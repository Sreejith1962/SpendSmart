...
// const API_URL = "http://127.0.0.1:8000/predict"; // Change to your backend IP
...
//   console.log("sname=", sname?.symbol);
...
//         tickers: ["TATAPOWER.NS"], // Change to required stock ticker
...
//   const allDates = Object.keys(stockData).slice(-timeFrames[timeFrame]); // Extract last N dates
//   const values = Object.values(stockData).slice(-timeFrames[timeFrame]); // Extract last N closing prices
...
//       <Text style={{ fontSize: 20, fontWeight: "bold", marginBottom: 10 }}>Stock Chart</Text>
...
//           <LineChart
//             data={{
//               labels: getDateRangeLabels(allDates), // Key dates
...
//               borderRadius: 100,
//               decimalPlaces: 2,
//               color: () => "#555555", // White color for the line
//               labelColor: () => "#FFFFFF", // White color for the labels
//               propsForDots: {
//                 r: "0.5",
//                 strokeWidth: "0.5",
//                 stroke: "#ffffff",
...
//               }}
//             >
//               <Text style={{ color: "#ffffff" ,fontSize: 30, fontWeight: 'bold'}}>₹{selectedPrice.toFixed(2)}</Text>
...
//   const selectedTicker = sname?.symbol; // Default if not provided
...
//   return (
//     <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 10 }}>
//       <Text style={{ fontSize: 20, fontWeight: "bold", marginBottom: 10 }}>{selectedTicker} Stock Chart</Text>
