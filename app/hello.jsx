...
export default function Home({ navigation }) {
  ...
  <View style={styles.buttonRow}>
    <TouchableOpacity style={styles.circleb} onPress={() => router.replace('/(goals)/Addgoals')}>
      ...
      <Text style={styles.coursetext}>Bank</Text>
    </TouchableOpacity>

    <TouchableOpacity style={styles.circleb} onPress={() => alert('Bank')}>
  ...
  {/* Second Row */}
  <View style={styles.buttonRow}>
    <TouchableOpacity style={styles.circleb} onPress={() => alert('Shop')}>
      <Icon name="shopping-cart" size={60} color="black" />
      <Text style={styles.coursetext}>Shop</Text>
    </TouchableOpacity>
